...
const COMPONENT_REGISTRY: ComponentDef[] = [
  ...
  {
    component: 'LimitedExpeditionDetail',
    label: 'Limited Expedition Detail Pages',
    file: 'src/views/LimitedExpeditionDetailView.vue',
    sections: [
      { section: 'freediving_hero', label: 'Freediving — Hero Image', slots: [
        { slotIndex: 0, label: 'Hero Image', defaultMediaType: 'image' },
      ]},
      { section: 'freediving_about', label: 'Freediving — About Image', slots: [
        { slotIndex: 0, label: 'About Image', defaultMediaType: 'image' },
      ]},
      { section: 'freediving_gallery', label: 'Freediving — Gallery (1-6)', slots: [
        { slotIndex: 0, label: 'Gallery Photo 1', defaultMediaType: 'image' },
        { slotIndex: 1, label: 'Gallery Photo 2', defaultMediaType: 'image' },
        { slotIndex: 2, label: 'Gallery Photo 3', defaultMediaType: 'image' },
        { slotIndex: 3, label: 'Gallery Photo 4', defaultMediaType: 'image' },
        { slotIndex: 4, label: 'Gallery Photo 5', defaultMediaType: 'image' },
        { slotIndex: 5, label: 'Gallery Photo 6', defaultMediaType: 'image' },
      ]},
      { section: 'freediving_itinerary', label: 'Freediving — Day Images (fallback, used if no itinerary added in Limited Expeditions admin)', slots: [
        { slotIndex: 0, label: 'Day 1 Image', defaultMediaType: 'image' },
        { slotIndex: 1, label: 'Day 2 Image', defaultMediaType: 'image' },
        { slotIndex: 2, label: 'Day 3 Image', defaultMediaType: 'image' },
        { slotIndex: 3, label: 'Day 4 Image', defaultMediaType: 'image' },
      ]},

      { section: 'surf_hero', label: 'Surf Expedition — Hero Image', slots: [
        { slotIndex: 0, label: 'Hero Image', defaultMediaType: 'image' },
      ]},
      { section: 'surf_about', label: 'Surf Expedition — About Image', slots: [
        { slotIndex: 0, label: 'About Image', defaultMediaType: 'image' },
      ]},
      { section: 'surf_gallery', label: 'Surf Expedition — Gallery (1-6)', slots: [
        { slotIndex: 0, label: 'Gallery Photo 1', defaultMediaType: 'image' },
        { slotIndex: 1, label: 'Gallery Photo 2', defaultMediaType: 'image' },
        { slotIndex: 2, label: 'Gallery Photo 3', defaultMediaType: 'image' },
        { slotIndex: 3, label: 'Gallery Photo 4', defaultMediaType: 'image' },
      ...
      { section: 'surf_itinerary', label: 'Surf Expedition — Day Images (fallback)', slots: [
        { slotIndex: 0, label: 'Day 1 Image', defaultMediaType: 'image' },
        { slotIndex: 1, label: 'Day 2 Image', defaultMediaType: 'image' },
        { slotIndex: 2, label: 'Day 3 Image', defaultMediaType: 'image' },
        { slotIndex: 3, label: 'Day 4 Image', defaultMediaType: 'image' },
      ...
      { section: 'whale-song_hero', label: 'Whale Song — Hero Image', slots: [
        { slotIndex: 0, label: 'Hero Image', defaultMediaType: 'image' },
      ]},
      { section: 'whale-song_about', label: 'Whale Song — About Image', slots: [
        { slotIndex: 0, label: 'About Image', defaultMediaType: 'image' },
      ]},
      { section: 'whale-song_gallery', label: 'Whale Song — Gallery (1-6)', slots: [
        { slotIndex: 0, label: 'Gallery Photo 1', defaultMediaType: 'image' },
        { slotIndex: 1, label: 'Gallery Photo 2', defaultMediaType: 'image' },
        { slotIndex: 2, label: 'Gallery Photo 3', defaultMediaType: 'image' },
        { slotIndex: 3, label: 'Gallery Photo 4', defaultMediaType: 'image' },
      ...
      { section: 'whale-song_itinerary', label: 'Whale Song — Day Images (fallback)', slots: [
        { slotIndex: 0, label: 'Day 1 Image', defaultMediaType: 'image' },
        { slotIndex: 1, label: 'Day 2 Image', defaultMediaType: 'image' },
        { slotIndex: 2, label: 'Day 3 Image', defaultMediaType: 'image' },
        { slotIndex: 3, label: 'Day 4 Image', defaultMediaType: 'image' },
      ...
      { section: 'underwater-photography_hero', label: 'Underwater Photography — Hero Image', slots: [
        { slotIndex: 0, label: 'Hero Image', defaultMediaType: 'image' },
      ]},
      { section: 'underwater-photography_about', label: 'Underwater Photography — About Image', slots: [
        { slotIndex: 0, label: 'About Image', defaultMediaType: 'image' },
      ]},
      { section: 'underwater-photography_gallery', label: 'Underwater Photography — Gallery (1-6)', slots: [
        { slotIndex: 0, label: 'Gallery Photo 1', defaultMediaType: 'image' },
        { slotIndex: 1, label: 'Gallery Photo 2', defaultMediaType: 'image' },
        { slotIndex: 2, label: 'Gallery Photo 3', defaultMediaType: 'image' },
        { slotIndex: 3, label: 'Gallery Photo 4', defaultMediaType: 'image' },
      ...
      { section: 'underwater-photography_itinerary', label: 'Underwater Photography — Day Images (fallback, 1-9)', slots: [
        { slotIndex: 0, label: 'Day 1 Image', defaultMediaType: 'image' },
        { slotIndex: 1, label: 'Day 2 Image', defaultMediaType: 'image' },
        { slotIndex: 2, label: 'Day 3 Image', defaultMediaType: 'image' },
        { slotIndex: 3, label: 'Day 4 Image', defaultMediaType: 'image' },
        { slotIndex: 4, label: 'Day 5 Image', defaultMediaType: 'image' },
        { slotIndex: 5, label: 'Day 6 Image', defaultMediaType: 'image' },
        { slotIndex: 6, label: 'Day 7 Image', defaultMediaType: 'image' },
        { slotIndex: 7, label: 'Day 8 Image', defaultMediaType: 'image' },
        { slotIndex: 8, label: 'Day 9 Image', defaultMediaType: 'image' },
      ]},

      { section: 'black-water_hero', label: 'Black Water — Hero Image', slots: [
        { slotIndex: 0, label: 'Hero Image', defaultMediaType: 'image' },
      ]},
      { section: 'black-water_about', label: 'Black Water — About Image', slots: [
        { slotIndex: 0, label: 'About Image', defaultMediaType: 'image' },
      ]},
      { section: 'black-water_gallery', label: 'Black Water — Gallery (1-6)', slots: [
        { slotIndex: 0, label: 'Gallery Photo 1', defaultMediaType: 'image' },
        { slotIndex: 1, label: 'Gallery Photo 2', defaultMediaType: 'image' },
        { slotIndex: 2, label: 'Gallery Photo 3', defaultMediaType: 'image' },
        { slotIndex: 3, label: 'Gallery Photo 4', defaultMediaType: 'image' },
      ...
      { section: 'black-water_itinerary', label: 'Black Water — Day Images (fallback, 1-9)', slots: [
        { slotIndex: 0, label: 'Day 1 Image', defaultMediaType: 'image' },
        { slotIndex: 1, label: 'Day 2 Image', defaultMediaType: 'image' },
        { slotIndex: 2, label: 'Day 3 Image', defaultMediaType: 'image' },
        { slotIndex: 3, label: 'Day 4 Image', defaultMediaType: 'image' },
      ...
      { section: 'wellness_hero', label: 'Wellness at Sea — Hero Image', slots: [
        { slotIndex: 0, label: 'Hero Image', defaultMediaType: 'image' },
      ]},
      { section: 'wellness_about', label: 'Wellness at Sea — About Image', slots: [
        { slotIndex: 0, label: 'About Image', defaultMediaType: 'image' },
      ]},
      { section: 'wellness_gallery', label: 'Wellness at Sea — Gallery (1-6)', slots: [
        { slotIndex: 0, label: 'Gallery Photo 1', defaultMediaType: 'image' },
        { slotIndex: 1, label: 'Gallery Photo 2', defaultMediaType: 'image' },
        { slotIndex: 2, label: 'Gallery Photo 3', defaultMediaType: 'image' },
        { slotIndex: 3, label: 'Gallery Photo 4', defaultMediaType: 'image' },
      ...
      { section: 'wellness_itinerary', label: 'Wellness at Sea — Day Images (fallback, 1-6)', slots: [
        { slotIndex: 0, label: 'Day 1 Image', defaultMediaType: 'image' },
        { slotIndex: 1, label: 'Day 2 Image', defaultMediaType: 'image' },
        { slotIndex: 2, label: 'Day 3 Image', defaultMediaType: 'image' },
        { slotIndex: 3, label: 'Day 4 Image', defaultMediaType: 'image' },
      ...
      { section: 'sharks-ningaloo_hero', label: 'Sharks of Ningaloo — Hero Image', slots: [
        { slotIndex: 0, label: 'Hero Image', defaultMediaType: 'image' },
      ]},
      { section: 'sharks-ningaloo_about', label: 'Sharks of Ningaloo — About Image', slots: [
        { slotIndex: 0, label: 'About Image', defaultMediaType: 'image' },
      ]},
      { section: 'sharks-ningaloo_gallery', label: 'Sharks of Ningaloo — Gallery (1-6)', slots: [
        { slotIndex: 0, label: 'Gallery Photo 1', defaultMediaType: 'image' },
        { slotIndex: 1, label: 'Gallery Photo 2', defaultMediaType: 'image' },
        { slotIndex: 2, label: 'Gallery Photo 3', defaultMediaType: 'image' },
        { slotIndex: 3, label: 'Gallery Photo 4', defaultMediaType: 'image' },
      ...
      { section: 'sharks-ningaloo_itinerary', label: 'Sharks of Ningaloo — Day Images (fallback)', slots: [
        { slotIndex: 0, label: 'Day 1 Image', defaultMediaType: 'image' },
        { slotIndex: 1, label: 'Day 2 Image', defaultMediaType: 'image' },
        { slotIndex: 2, label: 'Day 3 Image', defaultMediaType: 'image' },
        { slotIndex: 3, label: 'Day 4 Image', defaultMediaType: 'image' },
      ...
      { section: 'citizen-science_hero', label: 'Citizen Science — Hero Image', slots: [
        { slotIndex: 0, label: 'Hero Image', defaultMediaType: 'image' },
      ]},
      { section: 'citizen-science_about', label: 'Citizen Science — About Image', slots: [
        { slotIndex: 0, label: 'About Image', defaultMediaType: 'image' },
      ]},
      { section: 'citizen-science_gallery', label: 'Citizen Science — Gallery (1-6)', slots: [
        { slotIndex: 0, label: 'Gallery Photo 1', defaultMediaType: 'image' },
        { slotIndex: 1, label: 'Gallery Photo 2', defaultMediaType: 'image' },
        { slotIndex: 2, label: 'Gallery Photo 3', defaultMediaType: 'image' },
        { slotIndex: 3, label: 'Gallery Photo 4', defaultMediaType: 'image' },
      ...
      { section: 'citizen-science_itinerary', label: 'Citizen Science — Day Images (fallback)', slots: [
        { slotIndex: 0, label: 'Day 1 Image', defaultMediaType: 'image' },
        { slotIndex: 1, label: 'Day 2 Image', defaultMediaType: 'image' },
        { slotIndex: 2, label: 'Day 3 Image', defaultMediaType: 'image' },
        { slotIndex: 3, label: 'Day 4 Image', defaultMediaType: 'image' },
